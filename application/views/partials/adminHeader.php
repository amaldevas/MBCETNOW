              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-clone"></i> Blog <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>index.php/Home">Blog Home</a></li>
                   ...
                   <li><a><i class="fa fa-user"></i> User <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo base_url();?>index.php/user/user-list">View User</a></li>
                      <li><a href="<?php echo base_url();?>index.php/user/user-list">Edit User</a></li>
                      <li><a href="<?php echo base_url();?>index.php/user/user-list"> Delete User</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-edit"></i> POSTS <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo base_url();?>index.php/user/category-add">Add Category</a></li>
                       <li><a href="<?php echo base_url();?>index.php/user/category-list">Category</a></li>
